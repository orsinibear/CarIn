...
`,$=function(e,t,i,n){var r,o=arguments.length,a=o<3?t:null===n?n=Object.getOwnPropertyDescriptor(t,i):n;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)a=Reflect.decorate(e,t,i,n);else for(var s=e.length-1;s>=0;s--)(r=e[s])&&(a=(o<3?r(a):o>3?r(t,i,a):r(t,i))||a);return o>3&&a&&Object.defineProperty(t,i,a),a};let S=class extends n.oi{constructor(){super(...arguments),this.readOnly=!1,this.isInsufficientBalance=!1}render(){let e=this.readOnly||!this.token;return(0,n.dy)` <wui-flex
    ...
    >`}handleSelectButtonClick(){this.readOnly||a.RouterController.push("WalletSendSelectToken")}sendValueTemplate(){if(!this.readOnly&&this.token&&this.sendTokenAmount){let e=this.token.price*this.sendTokenAmount;return(0,n.dy)`<wui-text class="totalValue" variant="sm-regular" color="secondary"
      ...
      >`}return null}maxAmountTemplate(){return this.token?(0,n.dy)` <wui-text variant="sm-regular" color="secondary">
        ${g.Hg.roundNumber(Number(this.token.quantity.numeric),6,5)}
...
`,P=function(e,t,i,n){var r,o=arguments.length,a=o<3?t:null===n?n=Object.getOwnPropertyDescriptor(t,i):n;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)a=Reflect.decorate(e,t,i,n);else for(var s=e.length-1;s>=0;s--)(r=e[s])&&(a=(o<3?r(a):o>3?r(t,i,a):r(t,i))||a);return o>3&&a&&Object.defineProperty(t,i,a),a};let N=class extends n.oi{constructor(){super(),this.unsubscribe=[],this.tokenBalances=o.S.state.tokenBalances,this.search="",this.onDebouncedSearch=d.j.debounce(e=>{this.search=e}),this.fetchBalancesAndNetworkPrice(),this.unsubscribe.push(o.S.subscribe(e=>{this.tokenBalances=e.tokenBalances}))}disconnectedCallback(){this.unsubscribe.forEach(e=>e())}render(){return(0,n.dy)`
    ...
    `}async fetchBalancesAndNetworkPrice(){this.tokenBalances&&this.tokenBalances?.length!==0||(await this.fetchBalances(),await this.fetchNetworkPrice())}async fetchBalances(){await o.S.fetchTokenBalance(),o.S.fetchNetworkBalance()}async fetchNetworkPrice(){await c.nY.getNetworkTokenPrice()}templateSearchInput(){return(0,n.dy)`
    ...
    `}templateTokens(){return this.tokens=this.tokenBalances?.filter(e=>e.chainId===s.R.state.activeCaipNetwork?.caipNetworkId),this.search?this.filteredTokens=this.tokenBalances?.filter(e=>e.name.toLowerCase().includes(this.search.toLowerCase())):this.filteredTokens=this.tokens,(0,n.dy)`
      <wui-flex
    ...
    `}onBuyClick(){a.RouterController.push("OnRampProviders")}onInputChange(e){this.onDebouncedSearch(e.detail)}handleTokenClick(e){o.S.setToken(e),o.S.setTokenAmount(void 0),a.RouterController.goBack()}};N.styles=E,P([(0,r.SB)()],N.prototype,"tokenBalances",void 0),P([(0,r.SB)()],N.prototype,"tokens",void 0),P([(0,r.SB)()],N.prototype,"filteredTokens",void 0),P([(0,r.SB)()],N.prototype,"search",void 0),N=P([(0,g.Mo)("w3m-wallet-send-select-token-view")],N);var I=i(42935),D=i(44649),B=i(59388),z=i(31929);i(74975),i(23805),i(18360),i(5680);var O=i(84249),j=i(57116);i(48682);var V=i(11131),_=(0,V.iv)`
  :host {
    height: 32px;
    display: flex;
    align-items: center;
...
`,Y=function(e,t,i,n){var r,o=arguments.length,a=o<3?t:null===n?n=Object.getOwnPropertyDescriptor(t,i):n;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)a=Reflect.decorate(e,t,i,n);else for(var s=e.length-1;s>=0;s--)(r=e[s])&&(a=(o<3?r(a):o>3?r(t,i,a):r(t,i))||a);return o>3&&a&&Object.defineProperty(t,i,a),a};let K=class extends n.oi{constructor(){super(...arguments),this.params=a.RouterController.state.data?.send}render(){return(0,n.dy)` <wui-text variant="sm-regular" color="secondary">Details</wui-text>
      <wui-flex flexDirection="column" gap="1">
        <wui-list-content
          textTitle="Address"
          textValue=${g.Hg.getTruncateString({string:this.receiverAddress??"",charsStart:4,charsEnd:4,truncate:"middle"})}
        >
        </wui-list-content>
        ...
        class="network"
        textTitle="Network"
        imageSrc=${(0,F.o)(m.f.getNetworkImage(this.caipNetwork))}
      ></wui-list-content>`:null}onNetworkClick(e){e&&!this.params&&a.RouterController.push("Networks",{network:e})}};K.styles=q,Y([(0,r.Cb)()],K.prototype,"receiverAddress",void 0),Y([(0,r.Cb)({type:Object})],K.prototype,"caipNetwork",void 0),Y([(0,r.SB)()],K.prototype,"params",void 0),K=Y([(0,g.Mo)("w3m-wallet-send-details")],K);var Z=(0,g.iv)`
  wui-avatar,
  wui-image {
    display: ruby;
    width: 32px;
...
`,J=function(e,t,i,n){var r,o=arguments.length,a=o<3?t:null===n?n=Object.getOwnPropertyDescriptor(t,i):n;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)a=Reflect.decorate(e,t,i,n);else for(var s=e.length-1;s>=0;s--)(r=e[s])&&(a=(o<3?r(a):o>3?r(t,i,a):r(t,i))||a);return o>3&&a&&Object.defineProperty(t,i,a),a};let Q=class extends n.oi{constructor(){super(),this.unsubscribe=[],this.token=o.S.state.token,this.sendTokenAmount=o.S.state.sendTokenAmount,this.receiverAddress=o.S.state.receiverAddress,this.receiverProfileName=o.S.state.receiverProfileName,this.receiverProfileImageUrl=o.S.state.receiverProfileImageUrl,this.caipNetwork=s.R.state.activeCaipNetwork,this.loading=o.S.state.loading,this.params=a.RouterController.state.data?.send,this.unsubscribe.push(o.S.subscribe(e=>{this.token=e.token,this.sendTokenAmount=e.sendTokenAmount,this.receiverAddress=e.receiverAddress,this.receiverProfileName=e.receiverProfileName,this.receiverProfileImageUrl=e.receiverProfileImageUrl,this.loading=e.loading}),s.R.subscribeKey("activeCaipNetwork",e=>this.caipNetwork=e))}disconnectedCallback(){this.unsubscribe.forEach(e=>e())}render(){return(0,n.dy)` <wui-flex flexDirection="column" .padding=${["0","4","4","4"]}>
      <wui-flex gap="2" flexDirection="column" .padding=${["0","2","0","2"]}>
        <wui-flex alignItems="center" justifyContent="space-between">
          ...
          <wui-preview-item
            text="${this.sendTokenAmount?g.Hg.roundNumber(this.sendTokenAmount,6,5):"unknown"} ${this.token?.symbol}"
            .imageSrc=${this.token?.iconUrl}
          ></wui-preview-item>
        </wui-flex>
        <wui-flex>
        ...
        <wui-flex alignItems="center" justifyContent="space-between">
          ...
          <wui-preview-item
            text="${this.receiverProfileName?g.Hg.getTruncateString({string:this.receiverProfileName,charsStart:20,charsEnd:0,truncate:"end"}):g.Hg.getTruncateString({string:this.receiverAddress?this.receiverAddress:"",charsStart:4,charsEnd:4,truncate:"middle"})}"
    ...
    >`}sendValueTemplate(){if(!this.params&&this.token&&this.sendTokenAmount){let e=this.token.price*this.sendTokenAmount;return(0,n.dy)`<wui-text variant="md-regular" color="primary"
...
`;let G=class extends n.oi{constructor(){super(),this.unsubscribe=[],this.unsubscribe.push()}render(){return(0,n.dy)`
    ...
    `}onCloseClick(){l.I.close()}};G.styles=X,G=function(e,t,i,n){var r,o=arguments.length,a=o<3?t:null===n?n=Object.getOwnPropertyDescriptor(t,i):n;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)a=Reflect.decorate(e,t,i,n);else for(var s=e.length-1;s>=0;s--)(r=e[s])&&(a=(o<3?r(a):o>3?r(t,i,a):r(t,i))||a);return o>3&&a&&Object.defineProperty(t,i,a),a}([(0,g.Mo)("w3m-send-confirmed-view")],G)},78489:function(e,t,i){var n=i(31133),r=i(84927),o=i(7226),a=i(11131),s=i(84249),l=i(3874),c=i(57116),u=(0,a.iv)`
  :host {
    position: relative;
