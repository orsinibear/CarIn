"use strict";exports.id=7656,exports.ids=[7656],exports.modules={7656:(e,t,i)=>{i.r(t),i.d(t,{W3mWalletReceiveView:()=>$});var r=i(37207),o=i(90670),n=i(83479),a=i(42772),s=i(61741),c=i(98673),l=i(71106),d=i(52180),u=i(14212),w=i(34862),p=i(67668);i(35300),i(68865),i(71762),i(69834);var h=i(10820),m=i(18322),f=i(30955);let g=(0,f.iv)`
  button {
    width: 100%;
    display: flex;
    align-items: center;
...
`;var b=function(e,t,i,r){var o,n=arguments.length,a=n<3?t:null===r?r=Object.getOwnPropertyDescriptor(t,i):r;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)a=Reflect.decorate(e,t,i,r);else for(var s=e.length-1;s>=0;s--)(o=e[s])&&(a=(n<3?o(a):n>3?o(t,i,a):o(t,i))||a);return n>3&&a&&Object.defineProperty(t,i,a),a};let k=class extends r.oi{constructor(){super(...arguments),this.networkImages=[""],this.text=""}render(){return(0,r.dy)`
    ...
    </wui-flex>`}};k.styles=[h.ET,h.ZM,g],b([(0,o.Cb)({type:Array})],k.prototype,"networkImages",void 0),b([(0,o.Cb)()],k.prototype,"text",void 0),k=b([(0,m.M)("wui-compatible-network")],k),i(64559),i(96304),i(44680);var y=i(73372);let v=(0,p.iv)`
...
`;var x=function(e,t,i,r){var o,n=arguments.length,a=n<3?t:null===r?r=Object.getOwnPropertyDescriptor(t,i):r;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)a=Reflect.decorate(e,t,i,r);else for(var s=e.length-1;s>=0;s--)(o=e[s])&&(a=(n<3?o(a):n>3?o(t,i,a):o(t,i))||a);return n>3&&a&&Object.defineProperty(t,i,a),a};let $=class extends r.oi{constructor(){super(),this.unsubscribe=[],this.address=a.R.getAccountData()?.address,this.profileName=a.R.getAccountData()?.profileName,this.network=a.R.state.activeCaipNetwork,this.unsubscribe.push(a.R.subscribeChainProp("accountState",e=>{e?(this.address=e.address,this.profileName=e.profileName):s.SnackController.showError("Account not found")}),a.R.subscribeKey("activeCaipNetwork",e=>{e?.id&&(this.network=e)}))}disconnectedCallback(){this.unsubscribe.forEach(e=>e())}render(){if(!this.address)throw Error("w3m-wallet-receive-view: No account provided");let e=c.f.getNetworkImage(this.network);return(0,r.dy)` <wui-flex
    ...
    >
    ...
    </wui-flex>`}networkTemplate(){let e=a.R.getAllRequestedCaipNetworks(),t=a.R.checkIfSmartAccountEnabled(),i=a.R.state.activeCaipNetwork,o=e.filter(e=>e?.chainNamespace===i?.chainNamespace);if((0,d.r9)(i?.chainNamespace)===y.y_.ACCOUNT_TYPES.SMART_ACCOUNT&&t)return i?(0,r.dy)`<wui-compatible-network
      ...
      .networkImages=${n}
    ></wui-compatible-network>`}onReceiveClick(){u.RouterController.push("WalletCompatibleNetworks")}onCopyClick(){try{this.address&&(w.j.copyToClopboard(this.address),s.SnackController.showSuccess("Address copied"))}catch{s.SnackController.showError("Failed to copy")}}};$.styles=v,x([(0,o.SB)()],$.prototype,"address",void 0),x([(0,o.SB)()],$.prototype,"profileName",void 0),x([(0,o.SB)()],$.prototype,"network",void 0),$=x([(0,p.Mo)("w3m-wallet-receive-view")],$)}};