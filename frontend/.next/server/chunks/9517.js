...
`;var w=function(e,t,i,o){var r,n=arguments.length,a=n<3?t:null===o?o=Object.getOwnPropertyDescriptor(t,i):o;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)a=Reflect.decorate(e,t,i,o);else for(var s=e.length-1;s>=0;s--)(r=e[s])&&(a=(n<3?r(a):n>3?r(t,i,a):r(t,i))||a);return n>3&&a&&Object.defineProperty(t,i,a),a};let x={sm:"md-regular",md:"lg-regular",lg:"lg-regular"},v={success:"sealCheck",error:"warning",warning:"exclamationCircle"},$=class extends o.oi{constructor(){super(...arguments),this.type="success",this.size="md",this.imageSrc=void 0,this.disabled=!1,this.href="",this.text=void 0}render(){return(0,o.dy)`
    ...
    `}imageTemplate(){return this.imageSrc?(0,o.dy)`<wui-image src=${this.imageSrc} size="inherit"></wui-image>`:(0,o.dy)`<wui-icon
      name=${v[this.type]}
      weight="fill"
      color="inherit"
      size="inherit"
      class="image-icon"
    ></wui-icon>`}};$.styles=[m.ET,m.ZM,y],w([(0,r.Cb)()],$.prototype,"type",void 0),w([(0,r.Cb)()],$.prototype,"size",void 0),w([(0,r.Cb)()],$.prototype,"imageSrc",void 0),w([(0,r.Cb)({type:Boolean})],$.prototype,"disabled",void 0),w([(0,r.Cb)()],$.prototype,"href",void 0),w([(0,r.Cb)()],$.prototype,"text",void 0),$=w([(0,f.M)("wui-semantic-chip")],$),i(44680);let S=class extends o.oi{render(){return(0,o.dy)`
    ...
    `}toggleSmartAccountVersionTemplate(){return(0,o.dy)`
...
`;var U=function(e,t,i,o){var r,n=arguments.length,a=n<3?t:null===o?o=Object.getOwnPropertyDescriptor(t,i):o;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)a=Reflect.decorate(e,t,i,o);else for(var s=e.length-1;s>=0;s--)(r=e[s])&&(a=(n<3?r(a):n>3?r(t,i,a):r(t,i))||a);return n>3&&a&&Object.defineProperty(t,i,a),a};let B=class extends o.oi{constructor(){super(...arguments),this.name="",this.registered=!1,this.loading=!1,this.disabled=!1}render(){return(0,o.dy)`
    ...
    `}templateRightContent(){return this.loading?(0,o.dy)`<wui-loading-spinner size="lg" color="primary"></wui-loading-spinner>`:this.registered?(0,o.dy)`<wui-tag variant="info" size="sm">Registered</wui-tag>`:(0,o.dy)`<wui-tag variant="success" size="sm">Available</wui-tag>`}};B.styles=[m.ET,m.ZM,M],U([(0,r.Cb)()],B.prototype,"name",void 0),U([(0,r.Cb)({type:Boolean})],B.prototype,"registered",void 0),U([(0,r.Cb)({type:Boolean})],B.prototype,"loading",void 0),U([(0,r.Cb)({type:Boolean})],B.prototype,"disabled",void 0),B=U([(0,f.M)("wui-account-name-suggestion-item")],B);var V=i(83479);i(25685);let Y=(0,b.iv)`
  :host {
    position: relative;
    width: 100%;
...
`;var W=function(e,t,i,o){var r,n=arguments.length,a=n<3?t:null===o?o=Object.getOwnPropertyDescriptor(t,i):o;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)a=Reflect.decorate(e,t,i,o);else for(var s=e.length-1;s>=0;s--)(r=e[s])&&(a=(n<3?r(a):n>3?r(t,i,a):r(t,i))||a);return n>3&&a&&Object.defineProperty(t,i,a),a};let F=class extends o.oi{constructor(){super(...arguments),this.disabled=!1,this.loading=!1}render(){return(0,o.dy)`
      ...
      ></wui-input-text>
    `}};F.styles=[m.ET,Y],W([(0,r.Cb)()],F.prototype,"errorMessage",void 0),W([(0,r.Cb)({type:Boolean})],F.prototype,"disabled",void 0),W([(0,r.Cb)()],F.prototype,"value",void 0),W([(0,r.Cb)({type:Boolean})],F.prototype,"loading",void 0),W([(0,r.Cb)({attribute:!1})],F.prototype,"onKeyDown",void 0),F=W([(0,f.M)("wui-ens-input")],F),i(98855),i(1640),i(1159);var K=i(46821);let H=(0,d.iv)`
  wui-flex {
    width: 100%;
  }
...
`;var L=function(e,t,i,o){var r,n=arguments.length,a=n<3?t:null===o?o=Object.getOwnPropertyDescriptor(t,i):o;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)a=Reflect.decorate(e,t,i,o);else for(var s=e.length-1;s>=0;s--)(r=e[s])&&(a=(n<3?r(a):n>3?r(t,i,a):r(t,i))||a);return n>3&&a&&Object.defineProperty(t,i,a),a};let q=class extends o.oi{constructor(){super(),this.formRef=(0,P.V)(),this.usubscribe=[],this.name="",this.error="",this.loading=I.a.state.loading,this.suggestions=I.a.state.suggestions,this.profileName=A.R.getAccountData()?.profileName,this.onDebouncedNameInputChange=z.j.debounce(e=>{e.length<4?this.error="Name must be at least 4 characters long":K.g.isValidReownName(e)?(this.error="",I.a.getSuggestions(e)):this.error="The value is not a valid username"}),this.usubscribe.push(I.a.subscribe(e=>{this.suggestions=e.suggestions,this.loading=e.loading}),A.R.subscribeChainProp("accountState",e=>{this.profileName=e?.profileName,e?.profileName&&(this.error="You already own a name")}))}firstUpdated(){this.formRef.value?.addEventListener("keydown",this.onEnterKey.bind(this))}disconnectedCallback(){super.disconnectedCallback(),this.usubscribe.forEach(e=>e()),this.formRef.value?.removeEventListener("keydown",this.onEnterKey.bind(this))}render(){return(0,o.dy)`
    ...
    `}submitButtonTemplate(){let e=this.suggestions.find(e=>e.name?.split(".")?.[0]===this.name&&e.registered);if(this.loading)return(0,o.dy)`<wui-loading-spinner
        class="input-loading-spinner"
        color="secondary"
      ></wui-loading-spinner>`;let t=`${this.name}${C.b.WC_NAME_SUFFIX}`;return(0,o.dy)`
      <wui-icon-link
        ?disabled=${!!e}
    ...
    `}onNameInputChange(e){let t=K.g.validateReownName(e.detail||"");this.name=t,this.onDebouncedNameInputChange(t)}onKeyDown(e){1!==e.key.length||K.g.isValidReownName(e.key)||e.preventDefault()}templateSuggestions(){return!this.name||this.name.length<4||this.error?null:(0,o.dy)`<wui-flex flexDirection="column" gap="1" alignItems="center">
      ${this.suggestions.map(e=>(0,o.dy)`<wui-account-name-suggestion-item
            name=${e.name}
...
`,Q=class extends o.oi{render(){return(0,o.dy)`
      <wui-flex
        flexDirection="column"
        alignItems="center"
        gap="6"
    ...
    </wui-flex>`}redirectToAccount(){G.RouterController.replace("Account")}};Q.styles=Z,Q=function(e,t,i,o){var r,n=arguments.length,a=n<3?t:null===o?o=Object.getOwnPropertyDescriptor(t,i):o;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)a=Reflect.decorate(e,t,i,o);else for(var s=e.length-1;s>=0;s--)(r=e[s])&&(a=(n<3?r(a):n>3?r(t,i,a):r(t,i))||a);return n>3&&a&&Object.defineProperty(t,i,a),a}([(0,d.Mo)("w3m-register-account-name-success-view")],Q)}};